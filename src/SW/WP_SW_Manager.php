...
if ( ! class_exists( 'WP_SW_Manager' ) ) {
	 ...
	 */
	class WP_SW_Manager extends Core\Singleton {
		/**
		...
		protected function __construct() {
			$this->dynamic_server  = Core\WP_Serve_File::get_instance();
		...
		public function sw_registrar() {
			$contents = file_get_contents( __DIR__ . '/lib/js/sw-registrar.min.js' );
		...
		public function write_sw( $scope ) {
			...
			include( __DIR__ . '/lib/js/sw-base.min.js' );
			include( __DIR__ . '/lib/js/sw-start.min.js' );
