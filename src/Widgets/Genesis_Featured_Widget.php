...
abstract class Genesis_Featured_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays featured ' . $name . ' with thumbnails', SITECORE_PLUGIN_DOMAIN ),
		);
		...
		parent::__construct( 'featured-' . $this->post_type, __( 'Genesis - Featured ' . $name, SITECORE_PLUGIN_DOMAIN ), $widget_ops, $control_ops );
	...
	protected function get_defaults() {
		return array(
			...
			'content_limit'     => '',
			'more_text'         => __( '[Read More...]', SITECORE_PLUGIN_DOMAIN ),
			'extra_num'         => '',
			'extra_title'       => '',
			'class'             => '',
			'taxonomy'          => '',
	...
	public function widget( $args, $instance ) {
		...
		if ( have_posts() ) : while ( have_posts() ) : the_post();
			...
			$this->do_entry( $args, $instance, $wp_query->current_post );
	 ...
	 */
	function genesis_attr_entry( $attributes, $context, $args ) {

		if (
			empty( $args['params'] ) ||
			( ! empty( $args['params'] ) && empty( $args['params']['is_widget'] ) ||
			  ( ! empty( $args['params'] ) && isset( $args['params']['is_widget'] ) && ! $args['params']['is_widget'] )
			)
		) {
			return $attributes;
		}
        ...
        <div class="genesis-widget-column genesis-widget-column-right">
            ...
            <div class="genesis-widget-column-box genesis-widget-column-box-top">
                ...
                <p>
                    ...
                    <label for="<?php echo esc_attr( $this->get_field_id( 'show_title' ) ); ?>"><?php _e( 'Show Post Title', SITECORE_PLUGIN_DOMAIN ); ?></label>
                </p>

                <p>
                    <label for="<?php echo esc_attr( $this->get_field_id( 'show_content' ) ); ?>"><?php _e( 'Content Type', SITECORE_PLUGIN_DOMAIN ); ?>
                        :</label>
                    <select id="<?php echo esc_attr( $this->get_field_id( 'show_content' ) ); ?>"
						...
						<?php if ( post_type_supports( $this->post_type, 'content' ) ) : ?>
                            <option value="content" <?php selected( 'content', $instance['show_content'] ); ?>><?php _e( 'Show Content', SITECORE_PLUGIN_DOMAIN ); ?></option>
						<?php endif; ?>
						<?php if ( post_type_supports( $this->post_type, 'content' ) ) : ?>
                            <option value="excerpt" <?php selected( 'excerpt', $instance['show_content'] ); ?>><?php _e( 'Show Excerpt', SITECORE_PLUGIN_DOMAIN ); ?></option>
						<?php endif; ?>
						<?php if ( post_type_supports( $this->post_type, 'content' ) ) : ?>
                            <option value="content-limit" <?php selected( 'content-limit', $instance['show_content'] ); ?>><?php _e( 'Show Content Limit', SITECORE_PLUGIN_DOMAIN ); ?></option>
						<?php endif; ?>
                        <option value="" <?php selected( '', $instance['show_content'] ); ?>><?php _e( 'No Content', SITECORE_PLUGIN_DOMAIN ); ?></option>
                    </select>
					<?php if ( post_type_supports( $this->post_type, 'content' ) && $instance['show_content'] === 'content-limit' ) : ?>
                        <br/>
                        <label for="<?php echo esc_attr( $this->get_field_id( 'content_limit' ) ); ?>"><?php _e( 'Limit content to', SITECORE_PLUGIN_DOMAIN ); ?>
                            <input type="text" id="<?php echo esc_attr( $this->get_field_id( 'content_limit' ) ); ?>"
                                   name="<?php echo esc_attr( $this->get_field_name( 'content_limit' ) ); ?>"
                                   value="<?php echo esc_attr( (int) $instance['content_limit'] ); ?>" size="3"/>
							<?php _e( 'characters', SITECORE_PLUGIN_DOMAIN ); ?>
                        </label>
					<?php endif; ?>
                </p>
				...
				<?php if (
                    ...
                    <p>
                        <label for="<?php echo esc_attr( $this->get_field_id( 'more_text' ) ); ?>"><?php _e( 'More Text (if applicable)', SITECORE_PLUGIN_DOMAIN ); ?>
                            :</label>
			...
			<?php if ( post_type_supports( $this->post_type, 'thumbnail' ) ) : ?>
                <div class="genesis-widget-column-box">
                    ...
                    <p>
                        ...
                        <label for="<?php echo esc_attr( $this->get_field_id( 'show_image' ) ); ?>"><?php _e( 'Show Featured Image', SITECORE_PLUGIN_DOMAIN ); ?></label>
                    </p>

                    <p>
                        <label for="<?php echo esc_attr( $this->get_field_id( 'image_size' ) ); ?>"><?php _e( 'Image Size', SITECORE_PLUGIN_DOMAIN ); ?>
                            :</label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr( $this->get_field_id( 'image_alignment' ) ); ?>"><?php _e( 'Image Alignment', SITECORE_PLUGIN_DOMAIN ); ?>
                            :</label>
                        <select id="<?php echo esc_attr( $this->get_field_id( 'image_alignment' ) ); ?>"
                                onchange="wpsWidgetSave(this)"
                                name="<?php echo esc_attr( $this->get_field_name( 'image_alignment' ) ); ?>">
                            <option value="alignnone">- <?php _e( 'None', SITECORE_PLUGIN_DOMAIN ); ?> -</option>
                            <option value="alignleft" <?php selected( 'alignleft', $instance['image_alignment'] ); ?>><?php _e( 'Left', SITECORE_PLUGIN_DOMAIN ); ?></option>
                            <option value="alignright" <?php selected( 'alignright', $instance['image_alignment'] ); ?>><?php _e( 'Right', SITECORE_PLUGIN_DOMAIN ); ?></option>
                            <option value="aligncenter" <?php selected( 'aligncenter', $instance['image_alignment'] ); ?>><?php _e( 'Center', SITECORE_PLUGIN_DOMAIN ); ?></option>
                        </select>
                    </p>
	 ...
	 */
	function get_column_classes( $column_class = '', $count = 0, $extra_classes = '' ) {
