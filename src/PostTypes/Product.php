...
class Product extends Core\Post_Type {
...
//	}
	...
	public function create_post_type() {
		...
		$labels   = array(
			'name'                  => _x( 'Products', 'Post Type General Name', SITE_MU_TEXT_DOMAIN ),
			'singular_name'         => _x( 'Product', 'Post Type Singular Name', SITE_MU_TEXT_DOMAIN ),
			'menu_name'             => __( 'Products', SITE_MU_TEXT_DOMAIN ),
			'name_admin_bar'        => __( 'Products', SITE_MU_TEXT_DOMAIN ),
		...
		$args     = array(
			'label'               => __( 'Products', SITE_MU_TEXT_DOMAIN ),
			'description'         => __( 'For Products', SITE_MU_TEXT_DOMAIN ),
			'labels'              => $labels,
			'supports'            => $supports,
			'hierarchical'        => false,
			'public'              => true,
...
//	new WPS\Templates\Simple_Sidebars( $this->post_type );
	...
	function create_taxonomy() {
		...
		register_taxonomy( 'product-type', array( $this->post_type ), $args );
