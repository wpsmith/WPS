...
class Video extends WPS\Core\Post_Type {
	...
	public function video() {
		...
		$title = $title ? $title : __( 'Field Manual', SITE_MU_TEXT_DOMAIN );
		...
		printf( '<a target="_blank" href="%s" class="button accent alignright">%s</a>', get_permalink() . 'manual/', __( 'Open', SITE_MU_TEXT_DOMAIN ) );
		echo '</div></div>';
		echo '</div></div>';
	}
